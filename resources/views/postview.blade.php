...
<body class="w3-light-blue">
    ...
    <div class="job w3-light-grey w3-container w3-round-xlarge " id="summery">
        ...
        <div  style="float:right; margin:auto;">
            ...
            <a class="w3-button w3-large w3-border w3-border-green w3-round-large w3-hover-green"  style="display:block; margin:5px"  href="{{route('employer.post.edit',['id'=>$post->id])}}">Update</a>
            <a class="w3-button w3-large w3-border w3-border-green w3-round-large w3-hover-green"  style="display:block; margin:5px"  href="{{route('employer.post.listCV',['id'=>$post->id])}}">CV</a>
        </div>
        
            <h4><b>{{$post->company_name}}</b> - Email:{{$post->email}}</h4>
